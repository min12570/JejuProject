...
INSERT INTO `jan_res` (`jan_day`, `d_ondol`, `d_twin`, `t_ondol`, `o_ondol`, `suite_a`, `suite_b`, `suite_o`) VALUES
	...
	(20180103, 0, 2, 2, 2, 2, 2, 2),
	(20180104, 2, 2, 0, 2, 2, 2, 2),
	(20180105, 2, 2, 2, 2, 0, 2, 2),
	(20180106, 2, 2, 2, 0, 2, 2, 2),
	(20180107, 2, 2, 2, 2, 2, 2, 2),
	(20180108, 2, 0, 2, 2, 2, 2, 2),
	...
	(20180131, 2, 2, 2, 2, 2, 2, 2);

select * from jan_res;

select * from jan_res where (jan_day =1 or jan_day=2);

select * from jan_res where jan_day =2 and d_ondol>0;

--칼럼 이름 조회
SELECT COLUMN_NAME
FROM INFORMATION_SCHEMA.COLUMNS
WHERE TABLE_NAME = 'jan_res';

--0이상인 칼럼만 조회
SELECT COLUMN_NAME
FROM INFORMATION_SCHEMA.COLUMNS
WHERE TABLE_NAME = 'jan_res' and (select * from jan_res where );

	SELECT CASE D_ONDOL WHEN D_ONDOL > 0 THEN 0 
