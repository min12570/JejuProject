...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<script>
	...
	<!-- 지윤 상위 탭 삭제 <div class="nav">
		...
		<!--제목 삭제  <h3 class="bbs_tit mt40">패키지</h3>-->	
			...
			<div class="view_top">
				<h4 class="view_hd">[제주] 휘닉스 스쿠버 패키지</h4>
				<p class="view_hd2">
					<span>기간</span>
					<span class="hd_2 view_date">2017.11.01 ~ 2018.02.28</span>
					<span class="hd_1 "> 조회수 </span>
					<span class="hd_2 view_viewno"> 4719 </span>
				</p>
			</div>
			<div class="bbs_cont">
				...
				<img src="../../file/resort/Package/pkg_160803_5_01.jpg" alt="스쿠버이미지" />
									...
									<a href="javascript:;" id=7 onclick="goReser1()" class="btn_white"
