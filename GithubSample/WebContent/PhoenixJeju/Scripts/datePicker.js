...
$.dateRangePickerLanguages =
{
	'default':  //default language: English
	{
		...
		'default-default': '체크인 날짜와 체크아웃날짜를 선택하세요.',
		'time':'Time',
		'hour':'Hour',
		'minute':'Minute'
	}
...
$.fn.dateRangePicker = function(opt)
{
	...
	function updateCalendarWidth()
	{
		...
		//아름
		box.find('.month-wrapper').width("750px");
	}
	...
	function showSelectedInfo(forceValid,silent)
	{
		...
		if (opt.end)
		{
			...
			//체크인, 체크아웃 날짜 변수값에 담기
			var check_inGo = getDateString(new Date(parseInt(opt.start)));
			var check_outGo = getDateString(new Date(parseInt(opt.end)));
	
		    //체크인, 체크아웃 날짜 alert
			//alert((check_inGo) + " to " + getDateString(check_outGo));
			
			//체크인, 체크아웃 날짜 Jan_reSevlet.java로 보내기
			location.href="main.jan_res?check_inGo="+check_inGo + "&check_outGo=" + check_outGo;
		}
	...
	function createDom()
	{
		...
		html += '<div class="month-wrapper">'
			+'<table class="month1" cellspacing="0" border="0" cellpadding="0"><thead><tr class="caption"><th style="width:45px;"><span class="prev">&lt;</span></th><th colspan="'+_colspan+'" class="month-name"></th><th style="width:27px;">' + (opt.singleDate || !opt.stickyMonths ? '<span class="next">&gt;</span>': '') + '</th></tr><tr class="week-name">'+getWeekHead()+'</thead><tbody></tbody></table>';

		if ( hasMonth2() )
		{
			html += '<div class="gap">'+getGapHTML()+'</div>'
				+'<table class="month2" cellspacing="0" border="0" cellpadding="0"><thead><tr class="caption"><th style="width:45px;">' + (!opt.stickyMonths ? '<span class="prev">&lt;</span>': '') + '</th><th colspan="'+_colspan+'" class="month-name"></th><th style="width:27px;"><span class="next">&gt;</span></th></tr><tr class="week-name">'+getWeekHead()+'</thead><tbody></tbody></table>'
		}
			//+'</div>'
