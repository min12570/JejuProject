...
<body>
    <form method="post" action="./re_package_complete" id="ctl01">
<div class="aspNetHidden">
<input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="" />
<input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<!--                <div id="header">
    ...
    <div id="wrap">		
			...
			<div class="customer_top">
				<h2 class="cus_title"><img src="../_img/bbs/reservation.png"alt="통합예약" /></h2>
				<p class="cus_sub">고객님들의 예약을 빠르게 처리해 드리겠습니다.</p>
				<input type="hidden" id="folio" value="18470766">
			</div>

			<ul class="re_tab">
				<li style="width:166px" class="custab_off" onMouseOver="this.className='custab_over'" onMouseOut="this.className='custab_off'" onclick="location.href='/resort/reservation/re_room'">
					<p class="cus_text01">통합예약</p>
				</li>
				<li class="custab_on" onclick="location.href='/resort/reservation/re_package'">
					<p class="cus_text05 on" >패키지 예약</p>
				</li>
				<li  class="custab_off" onMouseOver="this.className='custab_over'" onMouseOut="this.className='custab_off'"
				onclick="location.href='/resort/reservation/re_confirm02'">
					<p class="cus_text03">예약 확인 /<br/> 변경 / 취소</p>
				</li>
				<li class="custab_off" onMouseOver="this.className='custab_over'" onMouseOut="this.className='custab_off'"
...
onclick="location.href='/resort/reservation/re_coupon'"> 
				...
				onclick="location.href='/pyeongchang/intro/traffic_stated'">
			...
			<div class="re_info_fini mb40">
				<div class="f_l">
					...
					<ul class="info_ul mt10">
						<li class="caller" style="width:200px;"><span>예약자명 : </span> <%= re_user_id %></li>
						<li class="rsrv_phone_no"><span>휴대전화 : </span> <%= re_user_contact %></li>
						<li class=" pt5 cs_email"><span>이메일 : </span><%= re_user_email %></li>
					</ul>
				</div>
				<div class="f_r">
					<p class="">투숙자정보</p>
					<ul class="info_ul mt10" style="">
						<li class="guest_name" style="width:200px;"><span>예약자명 : </span> <%= re_user_id %></li>
						<li class="use_phone_no"><span>휴대전화 : </span> <%= re_user_contact %></li>
						<li class="pt5 rs_email"><span>이메일 : </span> <%= re_user_email %></li>
					</ul>
				</div>
			</div>

			<div class="overflow mt20">
				<p class="f_l"><a class="btn_w130" href="/resort/reservation/re_confirm02">예약목록</a> <a class="btn_g_w130" href="#">인쇄하기</a></p>
				<p class="f_r"><a class="btn_g_w130" href="/resort/reservation/re_room">처음으로</a></p>
			</div>			
		</div>
	</div>
